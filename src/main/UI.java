...
//			g2.drawRoundRect(gp.tileSize + (gp.tileSize/2) , gp.tileSize, gp.screenWidth -(gp.tileSize * 3),gp.screenHeight - (gp.tileSize * 4), 20, 20);
			...
			if(gp.mouseH.targetHit == true ) {
				...
				g2.drawString(Float.toString(yourTime), (int)(gp.screenWidth - (gp.tileSize * 4.5)), (gp.screenHeight / 2) + (gp.tileSize * 5));
			}
		}
		if(currentTime > 60) {
...
//			currentTime = (float)longTimer / 2;
			...
			g2.setFont(g2.getFont().deriveFont(30f));
			g2.drawString(curTime, gp.tileSize +(gp.tileSize / 2), (gp.screenHeight / 2) + (gp.tileSize * 5));
